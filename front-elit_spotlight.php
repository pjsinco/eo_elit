      ...
      <div class="row">
        <div class="unit size-1-of-1 module">
          <div id="spotlight" class="spotlight">
            <h3 class="vis-title">Where DO graduates practice</h3>
              ...
              <div class="vis-info">
                ...
                <form class="schools-form">
                  ...
                  <select id='schools' name='schools'>
                    ...
                    <option selected value="OU-HCOM">OU-HCOM</option>
                    <option value="PCOM">PCOM</option>
                    <option value="PNWU-COM">PNWU-COM</option>
                    <option value="RowanSOM">RowanSOM</option>
                    <option value="RVUCOM">RVUCOM</option>
                    <option value="TouroCOM-Harlem">TouroCOM-Harlem</option>
                    ...
                    <option value="VCOM-Carolinas Campus">VCOM-Carolinas Campus</option>
                    <option value="VCOM-Virginia Campus">VCOM-Virginia Campus</option>
                    <option value="WCUCOM">WCUCOM</option>
            ...
            <div class="spotlight__body">
              ...
              <p class="spotlight__body-text">The results draw from a set of more than 44,000 AOA members who are under 65 and in practice.</p>
