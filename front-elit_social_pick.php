        ...
        <div class="size-1-of-1 social-pick-red module">
          ...
          <div class="social-pick-red__note"> 
            <ul class="social"> 
              ...
              <li class="social__icon"><a href="https://twitter.com/TheDOmagazine" class="social__link" target="_blank"><span class="icon-twitter"><span class="text-replace">Twitter</span></span></a></li>
